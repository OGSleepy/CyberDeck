...
CyberDeck is a fully browser-based TweetDeck-style Nostr client with a cypherpunk aesthetic. It features multi-column layout, auto-refreshing feeds, Lightning zaps, and complete client-side operation with no backend required. Built with React 18.x, TailwindCSS 3.x, Vite, shadcn/ui, and Nostrify.

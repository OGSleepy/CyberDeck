...
const defaultConfig: AppConfig = {
  ...
  relayMetadata: {
    relays: [
      ...
      { url: 'wss://relay.nostr.wirednet.jp', read: true, write: true },
      { url: 'wss://nostr.oxtr.dev', read: true, write: true },
      { url: 'wss://relay.mostr.pub', read: true, write: true },
      { url: 'wss://nostr-pub.wellorder.net', read: true, write: true },
      { url: 'wss://nostr.fmt.wiz.biz', read: true, write: true },
      { url: 'wss://relay.siamstr.com', read: true, write: true },
      { url: 'wss://relay.orangepill.dev', read: true, write: true },
    ],
    updatedAt: 0,
  },
};
